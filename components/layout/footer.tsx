      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-12">
          ...
          <div className="flex gap-8 text-sm font-medium text-slate-400">
            <a href="#" className="hover:text-emerald-500 transition-colors">Product</a>
            <a href="#" className="hover:text-emerald-500 transition-colors">Pricing</a>
            <a href="#" className="hover:text-emerald-500 transition-colors">Company</a>
            <a href="/terms" className="hover:text-emerald-500 transition-colors">Terms and Conditions</a>
